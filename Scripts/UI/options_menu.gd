...
func _on_game_activate_onboarding_value_changed(is_on_boarding_activate: bool) -> void:
	GameOptions.saved_options.activate_on_boarding = is_on_boarding_activate

...
@onready var activate_onboarding: ToggleButtonWithName = $Control/VBoxContainer/ActivateOnboarding
...
func apply_options(option_ressource: OptionsResource):
	activate_onboarding.set_toggle_button(option_ressource.activate_on_boarding)
